...
import InventoryType from './inventory-type/inventory-type.service'
import Inventory from './inventory/inventory.service'

export default [CollectionType, ComponentType, Inventory, InventoryType, Entity, Collection, Component, ContentPack, Project]
